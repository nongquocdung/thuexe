...
import { CauHinhGia_Form, Info_Form } from '../DanhSachTaiXe-const'

const ThemTaiXeDialogStyled = styled(Dialog)(({ theme }) => ({
    width: '100%',
    height: '100%',
    "& .car-info": {
        marginBottom: 10,
...
const ThemTaiXeDialog = ({ dialog, setDialog, callback = () => { } }) => {
                ...
                <div className="car-info">
                    ...
                    >
                        <div style={{ display: 'flex' }}>
                            <Typography className='form-title'>Thông tin tài xế</Typography>
                        </div>
                    </Paper>
...
export default ThemTaiXeDialog